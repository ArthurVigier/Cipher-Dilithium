...
@image_api.route('/generate_signature', methods=['POST'])
...
@image_api.route('/generate_signature_from_image', methods=['POST'])
def generate_signature_from_image_route():
    ...
    for image_file in image_files:
        ...
        # Use the image data as the message for generate_signature
        pq_signature, ecc_signature, pq_public_key, ecc_public_key = generate_signature(image_data)
...
def verify_signature_route():
    ...
    app.logger.info('File and image received for signature verification')
